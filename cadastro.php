...
$sql = 'INSERT INTO tb_usuario (nome,telefone,dt_nascimento,estado,genero,interesse,observacao) VALUES (\'' .$nome.'\',\''.$telefone.'\',\''.$data.'\',\''.$estado.'\',\''.$genero.'\',\''.$interesses.'\',\''.$observacao.'\')';


if (mysqli_query($_con, $sql)) {
   echo "<br> <p class='text-center mt-5 fs-1 fw-bold m-2'>Novo registro criado com sucesso</p>";
